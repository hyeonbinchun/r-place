...
def lambda_handler(event, context):
    ...
    logger.info(f"Creds_provider: {creds_provider}")
    ...
    try:
        ...
        # Store the ID with a placeholder value and a 2-hour TTL
        redis_client.set(key, "active", ex=7200) 
        
        logger.info(f"Connected. ID {connection_id} stored with TTL.")
